$(function() {
    ...
    if ( !(triggerCode == 200 || handleCode != 0) ) {
        ...
        $('#logConsole').append('<span style="color: red;">'+ I18n.job_log_rolling_log_trigger_fail +'</span>');
        return;
    }
    ...
    function pullLog() {
        ...
        if (pullFailCount++ > 20) {
            logRunStop('<span style="color: red;">'+ I18n.job_log_rolling_log_fail_often +'</span>');
            return;
        }

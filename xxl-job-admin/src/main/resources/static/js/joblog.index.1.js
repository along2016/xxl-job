$(function() {
    ...
    rangesConf[I18n.dateRangePickerr_ranges_today] = [moment().startOf('day'), moment().endOf('day')];
	...
	$('#filterTime').daterangepicker({
        ...
        startDate: rangesConf[I18n.dateRangePickerr_ranges_today][0],
        endDate: rangesConf[I18n.dateRangePickerr_ranges_today][1]
	});

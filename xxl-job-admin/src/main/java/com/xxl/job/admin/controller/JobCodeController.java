...
public class JobCodeController {
	...
	public String index(HttpServletRequest request, Model model, int jobId) {
		...
		if (jobInfo == null) {
			throw new RuntimeException(I18nUtil.getString("job_info_glue_jobId_invalid"));
		}
		if (GlueTypeEnum.BEAN == GlueTypeEnum.match(jobInfo.getGlueType())) {
			throw new RuntimeException(I18nUtil.getString("job_info_glue_glue_type_invalid"));
		}
